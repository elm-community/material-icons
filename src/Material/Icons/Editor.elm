module Material.Icons.Editor where
...
border_horizontal : Color -> Int -> Svg
border_horizontal =
...
format_color_fill : Color -> Int -> Svg
...
format_color_reset : Color -> Int -> Svg
format_color_reset =
...
format_color_text : Color -> Int -> Svg
...
format_list_numbered : Color -> Int -> Svg
...
insert_invitation : Color -> Int -> Svg
insert_invitation =
...
publish : Color -> Int -> Svg
publish =
  icon "M5 4v2h14V4H5zm0 10h4v6h6v-6h4l-7-7-7 7z"

space_bar : Color -> Int -> Svg
space_bar =
  icon "M18 9v4H6V9H4v6h16V9z"

strikethrough_s : Color -> Int -> Svg
strikethrough_s =
