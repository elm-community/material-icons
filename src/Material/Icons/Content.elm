module Material.Icons.Content where
...
add_box : Color -> Int -> Svg
add_box =
  icon "M19 3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-2 10h-4v4h-2v-4H7v-2h4V7h2v4h4v2z"

add_circle : Color -> Int -> Svg
add_circle =
  icon "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm5 11h-4v4h-2v-4H7v-2h4V7h2v4h4v2z"

add_circle_outline : Color -> Int -> Svg
add_circle_outline =
...
forward : Color -> Int -> Svg
forward =
  icon "M12 8V4l8 8-8 8v-4H4V8z"

gesture : Color -> Int -> Svg
gesture =
...
inbox : Color -> Int -> Svg
inbox =
  icon "M19 3H4.99c-1.1 0-1.98.9-1.98 2L3 19c0 1.1.89 2 1.99 2H19c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 12h-4c0 1.66-1.34 3-3 3s-3-1.34-3-3H4.99V5H19v10zm-3-5h-2V7h-4v3H8l4 4 4-4z"
...
remove : Color -> Int -> Svg
remove =
  icon "M19 13H5v-2h14v2z"

remove_circle : Color -> Int -> Svg
remove_circle =
  icon "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm5 11H7v-2h10v2z"

remove_circle_outline : Color -> Int -> Svg
remove_circle_outline =
  icon "M7 11v2h10v-2H7zm5-9C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"

reply : Color -> Int -> Svg
reply =
  icon "M10 9V5l-7 7 7 7v-4.1c5 0 8.5 1.6 11 5.1-1-5-4-10-11-11z"

reply_all : Color -> Int -> Svg
reply_all =
  icon "M7 8V5l-7 7 7 7v-3l-4-4 4-4zm6 1V5l-7 7 7 7v-4.1c5 0 8.5 1.6 11 5.1-1-5-4-10-11-11z"

report : Color -> Int -> Svg
report =
...
text_format : Color -> Int -> Svg
text_format =
  icon "M5 17v2h14v-2H5zm4.5-4.2h5l.9 2.2h2.1L12.75 4h-1.5L6.5 15h2.1l.9-2.2zM12 5.98L13.87 11h-3.74L12 5.98z"
